...
include 'config.php';
        if((!isset ($_SESSION['nome']) == true) and (!isset ($_SESSION['tipo']) == true))
        {
            ...
            echo "<script>
              ...
              echo "<script>
                alert('Esta página só pode ser acessada por Usuário Administrador');
                window.location.href = 'index.php';
                </script>";
        }
            ...
            <div class="container">
                <div class="boxed boxedp4">
                        ...
                        <div class="col-md-6 col-md-offset-3">
                            ...
                            <form class="big-contact-form"  action="#" method="post" role="search">
                                <input type="text" class="form-control" name="usuario" placeholder="Pesquisar por nome">                                
                                <button type="submit" name="pesquisar" class="btn btn-primary">Pesquisar</button><br><br><br>
...
if (isset($_POST["pesquisar"])) {
   ...
   if ($resultado->num_rows > 0) {
        while ($linha = $resultado->fetch_assoc()) {
            ...
            echo "<td><a href='atualizar.php?id=" . $cod . "' ><img src='edit.png' ></a></td>";
            echo "<td><a href='gerenciar.php?del=" . $cod . "'><img src='delete.png'></a></td>";
            echo "</tr>";
        }
    } else {
